...
const textareaClass =
  "min-h-[78px] w-full resize-none rounded-2xl border border-[#DDE6EC] bg-white px-4 py-3 text-sm font-semibold leading-6 text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-emerald-400 focus:ring-4 focus:ring-emerald-100";
        ...
        <div className="grid gap-0 xl:grid-cols-[0.43fr_0.57fr]">
          <div className="border-b border-slate-100 p-5 sm:p-6 xl:border-b-0 xl:border-r">
            <SectionHeader
              ...
              subtitle="Liên kết các kênh của bạn để AI phân tích hiệu quả hơn."
            />
          ...
          <div className="p-5 sm:p-6">
            <SectionHeader
              ...
              subtitle="Cung cấp thông tin để AI hiểu rõ hơn về kênh và khán giả của bạn."
            />
