...
import { Eye, PackagePlus, Pencil, Sparkles } from "lucide-react";
...
export default function ProductForm({ channel, product, defaultValues }: ProductFormProps) {
  ...
  return (
    <section
      className={
        isEditing
          ? "rounded-[24px] border border-slate-200/80 bg-white p-6"
          : "sticky top-6 rounded-[24px] border border-slate-200/80 bg-white p-6 shadow-[0_18px_40px_rgba(15,23,42,0.06)]"
      }
    >
